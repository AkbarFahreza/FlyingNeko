    ...
    return (
        <div className="flex flex-col md:flex-row space-y-4 md:space-x-5 md:space-y-0 mt-10">
            ...
            <div className="bg-pink-500 rounded-2xl px-4 py-10 text-black w-96 flex flex-col justify-center">
                ...
                <a className="bg-white text-pink-500 font-bold p-4 text-center rounded-full mx-auto" href="https://twitter.com/messages/compose?recipient_id=1356941102247333890">Mulai Dari IDR 85K</a>
            </div>
